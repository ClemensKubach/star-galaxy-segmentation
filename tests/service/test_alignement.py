...
@patch(
    "star_analysis.service.alignment.AlignmentService._AlignmentService__align_image",
    autospec=True)
@patch(
    "star_analysis.service.alignment.AlignmentService._AlignmentService__get_lost_pixel_count",
    autospec=True)
@patch(
    "star_analysis.service.alignment.AlignmentService._AlignmentService__load_files",
    autospec=True)
def test_alignment_is_optimal(
    ...
    file_load_function_mock.return_value = {
        "0": 1, "1": 2, "2": 3, "3": 4, "4": np.ones((2, 2)) * 5}
